class UpdateNoRepairModel {
  bool? status;
  String? message;
  Data? data;

  UpdateNoRepairModel({this.status, this.message, this.data});

  UpdateNoRepairModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
